...
class Viweskills extends StatelessWidget {
  const Viweskills({super.key});
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final bool isTablet = screenWidth >= 600 && screenWidth < 999;
        final bool isMediumScreen = screenWidth >= 900 && screenWidth < 1067;
